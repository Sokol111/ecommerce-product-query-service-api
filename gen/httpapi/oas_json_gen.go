...
var jsonFieldsNameOfProductAttribute = [8]string{
	0: "attributeId",
	1: "slug",
	2: "name",
	3: "type",
...
func (s *ProductAttribute) Decode(d *jx.Decoder) error {
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		case "values":
			...
			if err := func() error {
				s.Values = make([]AttributeValue, 0)
				if err := d.Arr(func(d *jx.Decoder) error {
...
// Encode encodes ProductAttributeRole as json.
func (s ProductAttributeRole) Encode(e *jx.Encoder) {
	e.Str(string(s))
}

// Decode decodes ProductAttributeRole from json.
func (s *ProductAttributeRole) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode ProductAttributeRole to nil")
	}
	v, err := d.StrBytes()
	if err != nil {
		return err
...
// MarshalJSON implements stdjson.Marshaler.
func (s ProductAttributeRole) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *ProductAttributeRole) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}

// Encode encodes ProductAttributeType as json.
func (s ProductAttributeType) Encode(e *jx.Encoder) {
	e.Str(string(s))
}

// Decode decodes ProductAttributeType from json.
func (s *ProductAttributeType) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode ProductAttributeType to nil")
	}
	v, err := d.StrBytes()
	if err != nil {
		return err
...
// MarshalJSON implements stdjson.Marshaler.
func (s ProductAttributeType) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *ProductAttributeType) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}
